...
export default function LoginScreen({ navigation }) {
    ...
    useEffect(() => {
        Animated.sequence([
            Animated.timing(logoAnim, { toValue: 1, duration: 750, useNativeDriver: true }),
            Animated.parallel([
        ...
        <SafeAreaView style={styles.safe}>
            ...
            >
                <View style={styles.scroll}>
                    ...
                    <FoodBadge emoji="🥩" style={{ top: height * 0.09, left: 18 }} delay={100} />
                    <FoodBadge emoji="🐔" style={{ top: height * 0.13, right: 22 }} delay={350} />
                    <FoodBadge emoji="🥦" style={{ top: height * 0.18, left: 55 }} delay={600} />
                    <FoodBadge emoji="🥚" style={{ top: height * 0.075, right: 65 }} delay={200} />
                        ...
                        {!showOtpCard && (
                            ...
                            >
                                ...
                                <View style={styles.cardHeader}>
                                    ...
                                    <Text style={styles.cardSubtitle}>we'll send you one-time password to sign-in securely</Text>
                                </View>
                                ...
                                <View style={styles.otpInfoContainer}>
                                    ...
                                    <Text style={styles.otpInfoText}>Fast, private, and protected sign in</Text>
                                </View>
                            </Animated.View>
                        )}
                        ...
                        {showOtpCard && (
                            ...
                            >
                                ...
                                <View style={styles.otpLabelRow}>
                                    ...
                                    <TouchableOpacity onPress={() => { setShowOtpCard(false); }}>
